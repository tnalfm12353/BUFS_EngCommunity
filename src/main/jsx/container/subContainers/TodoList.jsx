...
class TodoList extends React.Component {
    ...
    constructor(props) {
        ...
        const {code} = this.props.userInfo.toJS();
        this.getDB_Data(code);
    ...
    getDB_Data(code) {
        let selectcode = JSON.stringify({code: code});
        axios
            .post('/TodoSelect',selectcode,{
                headers: {
            ...
            .then(function (response) {
                console.log("in TodoSelect = " + JSON.stringify(response.data));
    ...
    */
    handleCreate() {
        ...
        /* Spring에 데이터 보내기 */
        let tododata = JSON.stringify({code: code, id: temp_id, text: input, checked: false, color:color});
    ...
    handleRemove(id) {
        const {code} =this.props.userInfo.toJS();
        let tododata = JSON.stringify({code: code,id: id})
